...
@InputType()
class ModelMetadataCreateInput {
  @ApiProperty({
    required: false,
    type: () => DetectionResultCreateNestedManyWithoutModelMetadataItemsInput,
  })
  @ValidateNested()
  @Type(() => DetectionResultCreateNestedManyWithoutModelMetadataItemsInput)
  @IsOptional()
  @Field(() => DetectionResultCreateNestedManyWithoutModelMetadataItemsInput, {
    nullable: true,
  })
...
export { ModelMetadataCreateInput as ModelMetadataCreateInput };
